<div id="mainCarousel" class="carousel slide carousel-fade" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img class="first-slide" src="<?php echo get_template_directory_uri() . '/assets/images/carousel1.jpg' ?>" alt="First slide">
    </div>
    <div class="item">
      <img class="second-slide" src="<?php echo get_template_directory_uri() . '/assets/images/carousel2.jpg' ?>" alt="Second slide">
    </div>
    <div class="item">
      <img class="third-slide" src="<?php echo get_template_directory_uri() . '/assets/images/carousel3.jpg' ?>" alt="Third slide">
    </div>
    <div class="item">
